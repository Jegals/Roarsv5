...
public class RoomPanel_luma extends javax.swing.JPanel {

    /**
     * Creates new form RoomPanel_luma
     */
...
tableInfo.setRowSorter(sorter);
    ...
    if (rowline != -1) {
        ...
        if (column == 0) {//roomnum cannot be modified because the systemn need to avoid duplication of room number
            JOptionPane.showMessageDialog(RoomPanel_luma.this, 
       ...
       boolean filled= updateRecordInFile(roomNumber, row, column, updatedValue);//if all info is fill when u
        ...
        if(filled){
        JOptionPane.showMessageDialog(RoomPanel_luma.this, "Record updated successfully!");
    }}
});
    }
    ...
    private void initComponents() {
        ...
        tableInfo.setBackground(new java.awt.Color(75, 146, 219));
